...
- Name: landing.spec.ts >> Landing Page >> should display contracts section with 3 contract cards
- Location: e2e/landing.spec.ts:47:7
...
Locator: locator('text=UserRegistry')
Expected: visible
Error: strict mode violation: locator('text=UserRegistry') resolved to 2 elements:
    1) <p class="mt-3 font-mono text-xs leading-relaxed text-[var(--text-muted)]">Publish your X25519 public key to the UserRegistr…</p> aka getByText('Publish your X25519 public')
    2) <h3 class="font-mono text-lg font-black tracking-tight">UserRegistry</h3> aka getByRole('heading', { name: 'UserRegistry' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=UserRegistry')
