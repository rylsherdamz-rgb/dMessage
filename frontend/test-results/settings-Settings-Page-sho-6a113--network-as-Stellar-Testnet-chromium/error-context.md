...
- Name: settings.spec.ts >> Settings Page >> should show network as Stellar Testnet
- Location: e2e/settings.spec.ts:17:7
...
Locator: locator('text=Stellar Testnet').or(locator('text=Connect your wallet'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Stellar Testnet').or(locator('text=Connect your wallet'))
